...
translate(v=[17.8,22.4,12]) rotate(a=90,v=[0,1,0]) hexagon(bot_hex,spring_length_min);
translate(v=[-18,22.4,12]) rotate(a=90,v=[0,1,0])  cylinder(r=bolt_dia/2,h=50);	

translate(v=[0,32.6,0]){
#	translate(v=[17.8,22,12]) rotate(a=90,v=[0,1,0]) hexagon(bot_hex,spring_length_min);	
	translate(v=[-18,22.4,12]) rotate(a=90,v=[0,1,0])  cylinder(r=bolt_dia/2,h=50);	
}


translate(v=[17.8,22.4,24]) rotate(a=90,v=[0,1,0]) rotate(a=30,v=[0,0,1]) hexagon(bot_hex,spring_length_min);
translate(v=[-18,22.4,24]) rotate(a=90,v=[0,1,0])  cylinder(r=bolt_dia/2,h=50);	

translate(v=[0,32.6,0]){
	translate(v=[17.8,22,24]) rotate(a=90,v=[0,1,0]) rotate(a=30,v=[0,0,1]) hexagon(bot_hex,spring_length_min);
	translate(v=[-18,22.4,24]) rotate(a=90,v=[0,1,0])  cylinder(r=bolt_dia/2,h=50);	
}
